...
public class XMLUtils {
	...
	public static List<Element> getChildrens(Element parentElement,
			String childName){
		...
		for (int i = 0; i < list.getLength(); i++) {
			...
			if(tagName.equals(childName)) result.add(node);
		}
		return result;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		Document document = XMLUtils.parse("src\\plantchain.xml");
