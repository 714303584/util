...
public final class RegExpValidatorUtils {
	...
	private static final Pattern  ValidHostnameRegex = Pattern
			.compile("^(([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9\\-]*[a-zA-Z0-9])\\.)*([A-Za-z0-9]|[A-Za-z0-9][A-Za-z0-9\\-]*[A-Za-z0-9])$");
	
	private static Pattern UrlRegex = Pattern.compile("((http|ftp|https)://)(([a-zA-Z0-9\\._-]+\\.[a-zA-Z]{2,6})|([0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}))(:[0-9]{1,4})*(/[a-zA-Z0-9\\&%_\\./-~-]*)?");
	
	public static boolean isUrl(String input){
		return UrlRegex.matcher(input).matches();
	}
	...
	public static boolean isHostName(String input){
		return ValidHostnameRegex.matcher(input).matches();
	}
